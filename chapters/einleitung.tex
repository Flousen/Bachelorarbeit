...
\begin{itemize}
	\item Mehrfaches Laden von Daten soll vermieden werden.
...
Ein einfacher QR-Algorithmus wie man ihn aus Numerik 1 \cite{num1} kennt, erreicht auf modernen Prozessoren nicht die theoretische Maximalleistung. 
