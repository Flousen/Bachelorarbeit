\section{Berechnung der Matrix T}
...
Mit Induktion kann man zeigen, dass eine Dreiecksmatrix $T \in \mathbb{R}^{n \times n}$ für alle $n$ existiert. (siehe \cite{Joffrain:2006:AHT:1141885.1141886}).
